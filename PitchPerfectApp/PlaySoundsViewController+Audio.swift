...
extension PlayAudioViewController: AVAudioPlayerDelegate {
    ...
    // Xcode give me an error : BAD_INSTRUCTION 
    // and fatal error: unexpectedly found nil while unwrapping an Optional value
    // so I will not use this feature and please help me explain this and how to solve this problem.
   /* func setPlayButtonsEnabled(enabled: Bool) {
        snailButton.isEnabled = enabled
        chipmunkButton.isEnabled = enabled
        kangarooButton.isEnabled = enabled
